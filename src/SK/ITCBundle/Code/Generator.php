...
class Generator
{
     ...
     */
    public function __construct(\Monolog\Logger $logger, Reflection $reflection)
    {
     ...
     */
    public function getClasses(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
     ...
     */
    protected function setClasses(Generator\Collection\ClassCollection $classes)
    {
     ...
     */
    public function getOperations(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
        	$this->setSettings( $settings );
     ...
     */
    protected function setOperations(Generator\Collection\OperationCollection $operations)
    {
     ...
     */
    public function getFiles(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
        	$this->setSettings( $settings );
        ...
        {
        	$files = [];
        	foreach( $this->getReflection()->getFiles() as $reflection )
        	{
        		$files[$reflection->getName()] = FileGenerator::fromReflectedFileName( $reflection->getName() );
        	}
     ...
     */
    protected function setFiles(Generator\Collection\FileCollection $files)
    {
        $this->files = $files;
        return $this;
    }
     ...
     */
    public function getPackages(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
        	$this->setSettings( $settings );
    ...
    protected function setPackages(Generator\Collection\PackageCollection $packages)
    {
     ...
     */
    public function getAttributes(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
        	$this->setSettings( $settings );
     ...
     */
    protected function setAttributes(Generator\Collection\AttributesCollection $attributes)
    {
     ...
     */
    public function getParameters(Generator\Settings $settings = null)
    {
        if( NULL !== $settings )
        {
        	$this->setSettings( $settings );
     ...
     */
    protected function setParameters(Generator\Collection\ParameterCollection $parameters)
    {
     ...
     */
    public function setSettings(Generator\Settings $settings)
    {
     ...
     */
    public function generate(\Zend\Code\Generator\FileGenerator $file, $fileName)
    {
        return file_put_contents($fileName, $file->generate());
    }
}